...
# Diverging pair (blue=alta priced, red=corte priced), gray midpoint — see
# the dataviz skill's palette.md. Dark-mode steps used when the browser is
# in dark mode (prefers-color-scheme), matched to the dark surface below.
