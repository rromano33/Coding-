...
class DailyNote(Base):
    ...
    pnl_rates: Mapped[float | None] = mapped_column(Float, nullable=True)
    pnl_fx: Mapped[float | None] = mapped_column(Float, nullable=True)
    pnl_equities: Mapped[float | None] = mapped_column(Float, nullable=True)
    pnl_other: Mapped[float | None] = mapped_column(Float, nullable=True)
